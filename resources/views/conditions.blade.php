...
<main class="spnav" style="background-color: lightgrey;" >
		<div class="container-fluid">

			<div class="container" style="padding-top: 120px;">
				<div class="row">
					<div class="col-12 center">
						<h1 style="color: red;">Utilisation des cookies</h1>

							<p>Cococar (« Cococar », « nous », « nos » ou « notre ») utilise les cookies afin de vous proposer un service web amélioré et davantage personnalisé. À travers cette Charte d’utilisation des Cookies de Cococar (la « Charte sur les Cookies »), nous vous présentons comment et pourquoi nous utilisons des cookies sur ce site, en toute transparence.</p>


							<h2>Qu’est-ce qu’un cookie et à quoi sert-il ?</h2>

							<p>Un cookie est un petit fichier texte enregistré, et/ou lu par votre navigateur, sur le disque dur de votre terminal (PC, ordinateur portable ou smartphone, par exemple) et déposé par les sites internet que vous visitez. Quasiment tous les sites utilisent des cookies pour bien fonctionner et optimiser leur ergonomie et leurs fonctionnalités. Les cookies rendent également les interactions avec les sites plus sécurisées et rapides, dans la mesure où ceux-ci peuvent se souvenir de vos préférences (telles que votre identifiant et votre langue) en renvoyant les informations qu’ils contiennent au site d’origine (cookie interne) ou à un autre site auquel ils appartiennent (cookie tiers), lorsque vous visitez à nouveau le site concerné à partir du même terminal. Selon leur fonction et le but de leur utilisation, les cookies sont classés parmi les catégories décrites ci-dessous et utilisées par Cococar sur ce site :</p>
							...
							<h2>Utilisation des cookies tiers</h2>

							<p>Veuillez noter que Cococar utilise les services de tiers pour connaître votre utilisation de ce site, ceci afin d’optimiser votre expérience utilisateur et d’afficher des publicités en dehors de ce site. Ces tierces parties (comme par exemple des réseaux d’annonceurs et des prestataires de services externes, tels que les services d’analyse de trafic web) peuvent également utiliser des cookies que nous ne maîtrisons pas.</p>


							<h2>Que faire si vous ne souhaitez pas activer les cookies ?</h2>

							<p></p> Vous pouvez révoquer votre consentement à l’utilisation des cookies à tout moment, de la façon suivante :<strong style="color: red;"> En paramétrant votre navigateur internet</strong></p>
							...
							<h2>En désactivant les cookies en ligne</h2>

							<p>Catégorie de cookie: Moyens de désactivation
							Cookies analytiques et de performance: Realytics
							Google Analytics
							Spoteffects
							Optimizely
							Cookies de ciblage ou publicitaires: DoubleClick
							Mediarithmics
							Cookies de réseaux sociaux: Facebook
							En utilisant des plateformes  en ligne de contrôle des cookies publicitaires :</p>


							<p>S’agissant des cookies publicitaires déposés par des tiers, vous pouvez également vous connecter au site Youronlinechoices, proposé par les professionnels de la publicité digitale regroupés au sein de l’association européenne EDAA (European Digital Advertising Alliance).</p>
